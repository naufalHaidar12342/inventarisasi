...
<div class="container d-flex flex-column align-items-start">
    <a href="<?= base_url(); ?>/Inventarisasi/inputAcct" class="btn btn-primary my-4 shadow">
...
<div class="container d-flex flex-column">
    <div class="row d-flex my-4">
        <div class="col-12">
            <a href="<?= base_url(); ?>/Inventarisasi/inputAcct" class="btn btn-success shadow disabled" aria-disabled="">
                <i class="bi bi-file-earmark-plus"></i>
                Tambah Data
            </a>
            <a href="<?= base_url(); ?>/Inventarisasi/akuntansi" class="btn btn-success shadow ms-2">
