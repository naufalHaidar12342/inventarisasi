...
<div class="container d-flex flex-column align-items-start">
    ...
    <a href="<?= base_url(); ?>/Inventarisasi/inputCS" class="btn btn-primary shadow my-4">
...
<div class="container d-flex flex-column">
    <div class="row d-flex mt-4 mb-3">
        <div class="col-12">
            <a href="<?= base_url(); ?>/Inventarisasi/inputCS" class="btn btn-success shadow disabled" aria-disabled="true">
                <i class="bi bi-file-earmark-plus"></i>
                Tambah Data
            </a>
            <a href="<?= base_url(); ?>/Inventarisasi/customerService" class="btn btn-success shadow ms-2">
                ...
                <?php foreach ($shows as $data) :    ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="" class="btn btn-primary shadow my-2 ms-2 justify-content-center d-flex">
                                <i class="bi bi-pencil"></i>
                                Ubah
                            </a>

                            <a href="" class="btn btn-danger my-2 ms-2 justify-content-center d-flex">
